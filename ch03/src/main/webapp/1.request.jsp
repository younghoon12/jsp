...
<head>
	...
	<%--
		...
		POST
			...
			- 전송 데이터는 주소에 노출되지 않고 요청 메세지 바디에 삽입되어 전송
...
<body>
	...
	<h4>request 기타 정보</h4>
	<p>
		해더정도 : <%= request.getHeader("User-Agent") %><br>
	...
	<form action="./proc/result3.jsp">
		<table border="1">
			...
			<tr>
				<td>비밀번호</td>
				<td><input type="text" name="pass" placeholder="비밀번호입력"/></td>
			</tr>
			<tr>
				<td>이름</td>
			...
			<tr>
				<td>생년월일</td>
				<td><input type="date" name="birth" placeholder="생년월일선택"/></td>
			</tr>
			<tr>
				<td>성별</td>
				<td>
